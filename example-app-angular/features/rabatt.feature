...
Funktionalität: Rabatt für eine Bohnenart berechnen
  ...
  Szenario: Ein neuer Rabatt soll gewährt werden
    Angenommen es gibt folgende Bohnenarten in der Anwendung
      ...
      | 0  | Äthiopien | 10.00                 | 30               | 13.00                 | 0.00   |
    Wenn der Bohnenverkäufer einen Rabatt von '10.00' Prozent gewährt
    Dann ist der Rabatt von '10.00' Prozent in der Anwendung sichtbar
